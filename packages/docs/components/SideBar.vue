...
<template>
  <div
    ...
    class="fixed top-12 z-10 h-100vh min-w-64 w-33vw flex flex-col items-end gap-2 bg-surface-variant-1 transition-transform,background-color md:translate-x-0"
  >
