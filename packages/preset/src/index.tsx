...
const rokuPreset: (options?: PresetOptions) => Preset<object> = (options = {}) => () => {
  ...
  return {
    ...
    shortcuts: {
      'custom-colors': 'border dark:text-[var(--d-text)] text-[var(--l-text)] dark:bg-[var(--d-fill)] bg-[var(--l-fill)] dark:border-[var(--d-border)] border-[var(--l-border)] dark:hover:bg-[var(--d-fill-h)] hover:bg-[var(--l-fill-h)] hover:text-[var(--l-text-h)] dark:hover:text-[var(--d-text-h)]',
      'custom-input-colors': 'border bg-[var(--l-fill)] dark:bg-[var(--d-fill)] text-[var(--l-text)] dark:text-[var(--d-text)] placeholder-[var(--l-placeholder)] dark:placeholder-[var(--d-placeholder)] border-[var(--l-border)] dark:border-[var(--d-border)] focus:border-[var(--l-border-f)] dark:focus:border-[var(--d-border-f)]',
    },
    presets: [
      presetUno({
        dark: {
