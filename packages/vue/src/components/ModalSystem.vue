...
<template>
  ...
  >
    ...
    >
      <Paper
        v-if="currentModal"
        class="border-surface-20 max-w-md w-full border p-6 shadow-xl"
        with-border
      >
        <div class="space-y-5">
          <div class="text-center space-y-2">
            <div class="mx-auto mb-4 h-12 w-12 flex items-center justify-center rounded-full bg-primary-10">
              <div class="bg-primary-50 h-6 w-6 rounded-full" />
            </div>
